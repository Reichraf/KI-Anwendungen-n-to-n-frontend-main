...
<div class="container text-center">
	...
	<div class="row justify-content-md-center">
	  ...
	  <div class="col-md-auto">
		<button type="button" class="btn btn-primary" on:click={handleSubmit1}>My linear_regression</button>
		<button type="button" class="btn btn-primary" on:click={handleSubmit2}>My randomforest_regression</button>
	  </div>
	</div>
  </div>